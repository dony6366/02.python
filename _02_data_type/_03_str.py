...
# 파이썬 객체 : str, list, tuple, ict, set 등
print('--- len()---')
text = '오늘 점심은 뭘 먹죠?'
print(text, len(text))
...
# str.replace(old, new)
# - str 내에서 old에 해당하는 문자를 new로 치환(qusrud)
print('---str.replace')
today = '2026-06-01'
...
# strat : 시작 인덱스 (생략 시 무조건 맨 앞에서 시작)
# stop : 종료 인덱스 (미포함)
...
print("text[6:len(text)] :", text[6:len(text)]) # 6 시작, 끝까지
